...
export default function ProjectThree() {
  return (
    <div className="projectThree">
      <h1>Rock the Vote </h1>
      <p>
        This application was built so that a user can keep track with issues
        that are important to their community. Built using React, Node, Express,
        Mongoose and MongoDB. Deployed using Heroku, and MongoDB for database.{" "}
      </p>
      <br />
