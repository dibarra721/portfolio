    ...
    return(
        ...
        <div className="projectOne">
            ...
            <p>This application was built so that a user can not only get the weather, but their astronomy information as well. The user 
                ...
                the user can also get their horoscope for the day. Built using React, Node, and express Express. Deployed using Surge.</p><br/>
            ...
            <div className="items">
                ...
                <a href="http://astroweather.surge.sh" target="_blank" rel="noreferrer" >
